//
//  CMAppViewController.m
//  GICircleMenu
//
//  Created by Gigih Iski Prasetyawan on 7/3/14.
//  Copyright (c) 2014 Etsuri Ltd. All rights reserved.
//

#import "CMAppViewController.h"
#import "GICircleMenu/GICircleMenu.h"

@interface CMAppViewController () <GIMenuDelegate>

@end

@implementation CMAppViewController {
    NSMutableArray *dataArray;
    
    GICircleMenu *circleMenu;
}
...
- (void)viewDidLoad
{
    ...
    circleMenu = [[GICircleMenu alloc] initWithTableView:self.tableView];
